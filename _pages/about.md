...
- XR prototyping with Unity, Unreal, and hand-tracking systems
- Multimodal haptic rendering including vibration, airflow, pressure, and EMS
- Physiological computing with EMG/EEG sensing and real-time inference
- Embedded integration using ESP32, ESP-IDF, serial JSON protocols, and hardware control
- Research-through-prototyping for embodied interaction and media design
